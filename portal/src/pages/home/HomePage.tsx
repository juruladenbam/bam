    ...
    return (
        <MobileLayout>
            <div className="flex-1">
                    ...
                    <div className="relative max-w-7xl mx-auto px-4 md:px-10 py-12 md:py-24">
                        <div className="max-w-3xl">
                            ...
                            <div className="flex flex-wrap gap-3 md:gap-4">
                                ...
                                <Link
                                    to="/events"
                                    className="px-5 py-2.5 md:px-6 md:py-3 bg-white/10 text-white rounded-lg font-medium hover:bg-white/20 transition-colors backdrop-blur-sm flex items-center gap-2"
                                >
                ...
                {/* Stats Section */}
                {stats && (
                    <div className="max-w-7xl mx-auto px-4 md:px-10 mt-6 md:-mt-8 relative z-10">
                ...
                {/* Quick Access Links - For Arsip & Lapor Data */}
