                ...
                <div className="max-w-7xl mx-auto px-4 md:px-10 py-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <Link
                            ...
                            className="group bg-white border border-[#e6dbdc] rounded-xl p-6 hover:shadow-lg hover:border-[#ec1325]/30 transition-all"
                        >
                            <div className="size-14 rounded-xl bg-orange-50 flex items-center justify-center mb-4 group-hover:bg-orange-500 transition-colors">
                                <span className="material-symbols-outlined text-3xl text-orange-500 group-hover:text-white transition-colors">
                                    event
                                </span>
                            </div>
                            <h3 className="text-lg font-bold text-[#181112] mb-2 group-hover:text-[#ec1325] transition-colors">
                            ...
                            <p className="text-sm text-[#896165]">
                                Jadwal Haul, silaturahmi, dan kegiatan keluarga besar lainnya.
                            </p>
                        </Link>
