...
FamilyTree.templates.sriniz.size = [300, 90];
...
<g id="sriniz_male_up">
    ...
    ${FamilyTree.icon.ft(15, 15, '#03e58b', 7.5, 7.5)}
</g>
...
FamilyTree.templates.sriniz_male.node =
    '<rect x="0" y="0" height="{h}" width="{w}" stroke-width="1" fill="#03e58b" stroke="#aeaeae" rx="15" ry="15"></rect>';
...
const expandIconMale =
    '<circle cx="97" cy="-16" r="10" fill="#03e58b" stroke="#fff" stroke-width="1"><title>Expand</title></circle>' +
...
FamilyTree.templates.sriniz.pointer =
    ...
    '<polygon fill="#03e58b" points="53.004,173.004 53.004,66.996 0,120" />' +
    '<polygon fill="#03e58b" points="186.996,66.996 186.996,173.004 240,120" />' +
