        ...
        <div className="relative" ref={containerRef}>
            ...
            <div className="relative">
                <input
                    ...
                    className="w-full px-4 py-3 bg-white border border-[#D4C5B2] rounded-xl text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#87A878]/30 focus:border-[#87A878] transition-all pr-10 shadow-sm"
                />
            ...
            {isOpen && (
                <div className="absolute z-50 w-full mt-2 bg-white border border-[#D4C5B2] rounded-xl shadow-xl max-h-60 overflow-y-auto divide-y divide-gray-50 focus:outline-none py-1 scrollbar-thin scrollbar-thumb-gray-200">
                            ...
                            return (
                                <button
                                    ...
                                    className={`w-full text-left px-4 py-2.5 text-sm flex flex-col transition-colors ${
                                        isSelected
                                            ? 'bg-[#87A878]/10 text-[#4A6741] font-semibold'
                                            : 'text-gray-700 hover:bg-[#F5F0E8]'
                                    }`}
                                >
